...
using CelestialMediaGroup.Permissions.Helpers;
using CelestialMediaGroup.STS.Identity.Configuration;
using CelestialMediaGroup.STS.Identity.Helpers;
using CelestialMediaGroup.STS.Identity.Helpers.Localization;
using CelestialMediaGroup.STS.Identity.ViewModels.Account;
using IdentityModel;
...
namespace CelestialMediaGroup.STS.Identity.Controllers
{
    [SecurityHeaders]
    [Authorize]    
        ...
        where TKey : IEquatable<TKey>
    {
        ...
        public async Task<IActionResult> Register([FromBody]RegisterViewModel model, string returnUrl = null)
        {
            ...
            if (result.Succeeded)
            {
                ...
                await _userManager.AddClaimAsync(user, new System.Security.Claims.Claim("roles", ApplicationPermissionMapper.GetPermissionsForApp(model.ApplicationName)));
