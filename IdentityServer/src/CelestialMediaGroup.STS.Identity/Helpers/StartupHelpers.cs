...
using CelestialMediaGroup.STS.Identity.Configuration.ApplicationParts;
using CelestialMediaGroup.STS.Identity.Configuration.Constants;
...
using CelestialMediaGroup.STS.Identity.Services;
using ILogger = Microsoft.Extensions.Logging.ILogger;

namespace CelestialMediaGroup.STS.Identity.Helpers
{
