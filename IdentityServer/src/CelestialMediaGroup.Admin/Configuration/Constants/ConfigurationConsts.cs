namespace CelestialMediaGroup.Admin.Configuration.Constants
{
    public class ConfigurationConsts
    {
        ...
        public const string CustomWebClientConfigurationsKey = "CustomWebClientConfigurations";

        public const string CustomAPIConfigurationsKey = "CustomAPIConfigurations";
    }
}