...
using CelestialMediaGroup.Admin.ExceptionHandling;
using CelestialMediaGroup.Admin.Helpers.Localization;
...
namespace CelestialMediaGroup.Admin.Controllers
{
        ...
        where TRoleClaimsDto : RoleClaimsDto<TRoleDtoKey>
    {
        ...
        [HttpGet]
        public async Task<IActionResult> RoleClaimsEdit(TRoleDtoKey id, int claimId)
        {
            if (EqualityComparer<TRoleDtoKey>.Default.Equals(id, default) ||
                EqualityComparer<int>.Default.Equals(claimId, default)) return NotFound();
        ...
        //[HttpPost]
        //[ValidateAntiForgeryToken]
        //public async Task<IActionResult> RoleClaimsEdit(RoleClaimsDto<TRoleDtoKey> claim)
        //{
        //    await _identityService.EditRoleClaimsAsync(claim);
        //    SuccessNotification(_localizer["SuccessEditRoleClaims"], _localizer["SuccessTitle"]);

        //    return RedirectToAction(nameof(RoleClaimsEdit), new { Id = claim.RoleId, claimId = claim.ClaimId });
        //}
